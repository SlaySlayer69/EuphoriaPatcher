...
const LANG_DIR = path.join(
  REPO_ROOT,
  "common/src/main/resources/assets/euphoria_patcher/lang",
);
...
const WHITELISTED_URL_PREFIXES = [
  "github.com/EuphoriaPatches/EuphoriaPatcher",
  "modrinth.com/mod/euphoria-patches",
  "curseforge.com/minecraft/mc-mods/euphoria-patches",
  "crowdin.com/project/euphoriapatchesmod",
  "euphoriapatches.com",
